...
export class AttemptsController {
	...
	async create(@Body() body: CreateAttemptDto): Promise<AttemptResponseDto> {
		return this.attemptsService.createAttempt(body.telegramInitData, body.points, body.stars);
	}

	// GET /attempts/best?telegramInitData=...
	@Get('best')
	async getBest(@Query() query: TelegramInitDataDto): Promise<AttemptResponseDto | null> {
